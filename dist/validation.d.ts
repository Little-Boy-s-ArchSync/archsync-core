...
import type { ArchitectureDocument, QualityGoalV02, ValidationIssue, ValidationResult } from "./model.js";
export declare function formatSchemaIssue(error: ErrorObject): ValidationIssue;
export declare function validateQualityGoal(value: unknown): Promise<ValidationResult<QualityGoalV02>>;
