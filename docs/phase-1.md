...
8. Statement, branch, function and line coverage remain exactly 100% for every deterministic engine module; built CLI behavior is additionally protected by 15/15 command-contract checks.
